...
import { Folder, ChevronLeft, Sparkles, Plus, Image as ImageIcon, Film, BookOpen, Upload } from 'lucide-react';
...
const FolderView: React.FC<FolderViewProps> = ({ groupedMovies, onPlay, onUploadToFolder }) => {
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6">
                  ...
                  {movies.map((movie, idx) => (
                      ...
                      >
                          ...
                          <div className="absolute top-2 right-2 glass p-1 rounded-full">
